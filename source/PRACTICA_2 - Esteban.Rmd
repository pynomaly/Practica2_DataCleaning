...
Eliminanos las variables con gran número de NA (`location`). Mantener una de las dos variables de dimensiones: `size` o `superficie`, eliminar la otra si es que encontramos una correlación grande entre las dos.
...
En general utilizando el dataset de DevianArt obtenido podemos predecir de forma precisa el nivel de favoritos que reciben estas imágenes y recomendar cuáles serían los temas y motivos de las imágenes que más influirán en que la valoración de una imagen sea mejor que otras. 

--> Falta incorporar contraste de hipótesis a estas conclusiones?